        ...
        <div class="container">
            ...
            <div class="featured-tab">
                <ul class="nav nav-pills nav-stacked col-md-3 padding-2px">
                    ...
                    <li><a href="#talents" data-toggle="tab"><i class="fa fa-star"></i> Talents</a></li>
                </ul>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="featured-post">
                                        <figure>
                                          ...
                                          <figcaption>
                                            <div class="post-view">
                                              <a href="{{ action('GalleryController@showGallery', array('id'=> $gallery->id))}}"><i class="fa fa-play-circle fa-5x pulse2"></i></a>
                                            </div>
                                          </figcaption>
                                        </figure>
